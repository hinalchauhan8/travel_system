...
public class Destinations extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run() {
        String[] text = new String[] { "JW Marriott Hotel", "Maandarin Oriental Hotel", "Fpur Seasons Hotel", "Raddisson Blue Hotel", "Classsio HOtel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel" };
        try {
            for(int i = 0; i < 9 ; i++) {
