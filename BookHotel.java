...
public class BookHotel extends JFrame implements ActionListener{
    ...
    BookHotel(String username) {
        ...
        try {
            ...
            while(rs.next()) {
                labelusername.setText(rs.getNString("username"));
                 labelid.setText(rs.getNString("id"));
                 labelnumber.setText(rs.getNString("number"));
                 labelphone.setText(rs.getNString("phone"));
                 }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == checkprice) {
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("insert into bookhotel values('"+labelusername.getText()+"', '"+chotels.getSelectedItem()+"', '"+tfpersons.getText()+"', '"+tfdays.getText()+"', '"+cac.getSelectedItem()+"', '"+cfood.getSelectedItem()+"', '"+labelid.getText()+"', '"+labelnumber.getText()+"', '"+labelphone.getText()+"', '"+labelprice.getText()+"')");
